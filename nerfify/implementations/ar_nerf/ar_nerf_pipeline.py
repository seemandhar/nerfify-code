...
from nerfify.methods.ar_nerf.ar_nerf_model import ARNeRFModelConfig, ARNeRFModel
    ...
    def __init__(
        ...
        if world_size > 1:
            self._model = typing.cast(
                ARNeRFModel, DDP(self._model, device_ids=[local_rank], find_unused_parameters=True)
            )
