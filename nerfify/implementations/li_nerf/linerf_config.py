...
from nerfify.methods.li_nerf.linerf_model import LiNeRFModelConfig
from nerfify.methods.li_nerf.linerf_pipeline import LiNeRFPipelineConfig
...
li_nerf = MethodSpecification(
    config=TrainerConfig(
        ...
        pipeline=LiNeRFPipelineConfig(
            datamanager=LiNeRFDataManagerConfig(
                train_num_rays_per_batch=4096, #4096
                eval_num_rays_per_batch=4096, #4096
            ),
            model=LiNeRFModelConfig(
