...
class LiNerfField(Field):
    ...
    def get_outputs(
        ...
        outputs.update({"POSITION_EMBEDDING": density_embedding})
        outputs.update({"DIRECTION_ENCODING": d})
        ...
        outputs.update({"APPEARANCE_EMBEDDING": embedded_appearance})
