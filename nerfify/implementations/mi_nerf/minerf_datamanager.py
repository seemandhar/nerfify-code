...
@dataclass
class MiNeRFDataManagerConfig(VanillaDataManagerConfig):
    """Template DataManager Config

    Add your custom datamanager config parameters here.
    """

    _target: Type = field(default_factory=lambda: MiNeRFDataManager)
    sample_annealing = True
    start_samples = 1024
    end_samples = 4096
    max_steps = 1000


class MiNeRFDataManager(VanillaDataManager):
    """BioNeRF DataManager
    ...
    config: MiNeRFDataManagerConfig
